...
Open [http://localhost:3001](http://localhost:3001) to view it in your browser. We use Port 3001 because the API that goes with this app is running on port 3000.
